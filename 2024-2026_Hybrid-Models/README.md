...
- **Yuval, J., Kochkov, D., et al. (2024).** _"Neural general circulation models for modeling precipitation."_ Science Advances (in press, described in Google Research blog).
  - Extension of NeuralGCM trained directly on satellite precipitation observations; improved small-scale physics representation
